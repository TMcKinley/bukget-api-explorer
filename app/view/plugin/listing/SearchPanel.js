Ext.define("Bukget.view.plugin.listing.SearchPanel", {
    ...
    },
    {
        ...
        anchor		: '100%',
        items		: [
            { boxLabel: 'Slug', 								name: 'slug', inputValue: 'inclusive' },
            { boxLabel: 'Plugin Name', 							name: 'plugin_name', inputValue: 'exclusive' },
            { boxLabel: 'Server', 								name: 'server', inputValue: 'exclusive' },
            { boxLabel: 'Categories', 							name: 'categories', inputValue: 'exclusive' },
            { boxLabel: 'Authors', 								name: 'authors', inputValue: 'exclusive' },
            { boxLabel: 'Logo', 								name: 'logo', inputValue: 'exclusive' },
            { boxLabel: 'Logo Full', 							name: 'logo_full', inputValue: 'exclusive' },
            { boxLabel: 'Webpage', 								name: 'webpage', inputValue: 'exclusive' },
            { boxLabel: 'Dbo_page', 							name: 'dbo_page', inputValue: 'exclusive' },
            { boxLabel: 'Description', 							name: 'description', inputValue: 'exclusive' },
            { boxLabel: 'Versions', 							name: 'versions', inputValue: 'exclusive' },
            { boxLabel: 'Versions.version',	 					name: 'versions.version', inputValue: 'exclusive' },
            { boxLabel: 'Versions.md5', 						name: 'versions.md5', inputValue: 'exclusive' },
